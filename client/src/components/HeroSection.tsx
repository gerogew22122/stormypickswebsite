        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6 max-w-md">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-md p-4" data-testid="stat-units-last-month">
                <div className="flex items-center gap-2 mb-2">
                  <TrendingUp className="w-5 h-5 text-accent" />
                  <div className="text-3xl font-bold text-white">+247</div>
                </div>
                <div className="text-white/60 text-xs uppercase tracking-wide">Units Last Month</div>
              </div>

              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-md p-4" data-testid="stat-total-units">
                <div className="flex items-center gap-2 mb-2">
                  <Users className="w-5 h-5 text-primary" />
                  <div className="text-3xl font-bold text-white">1,842</div>
                </div>
                <div className="text-white/60 text-xs uppercase tracking-wide">Total Units</div>
              </div>
            </div>
