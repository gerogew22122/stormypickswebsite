        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="max-w-md">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-md p-6" data-testid="stat-units-profited">
                <div className="flex items-center gap-3 mb-2">
                  <TrendingUp className="w-6 h-6 text-accent" />
                  <div className="text-4xl font-bold text-white">152.51</div>
                </div>
                <div className="text-white/60 text-sm uppercase tracking-wide">Units Profited Since June</div>
              </div>
            </div>
